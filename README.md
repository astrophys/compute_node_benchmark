...
## Installation:
There are two primary ways of running this code. 
...
#### Build / Run:
1. `$ git clone https://github.com/astrophys/compute_node_benchmark.git`
2. `$ cd compute_node_benchmark`    
3. `$ bash build.sh  # must be run from within compute_node_benchmark/`
3. `$ bash run.sh # must be run from within compute_node_benchmark/`
